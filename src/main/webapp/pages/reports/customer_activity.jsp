...
<div id="searchPanel" class="easyui-panel" style="padding:10px;" title="查询窗口" iconCls="icon-search" collapsible="true"
    ...
    <table id="searchTable">
        <tr>
            ...
            <td>排序：</td>
            <td>
                <input id="Sort" name="Sort" style="width:120px;"/>
            </td>
            <td>&nbsp;</td>
            <td>单据日期：</td>
            <td>
...
<!-- 数据显示table -->
<div id="tablePanel" class="easyui-panel" style="padding:1px;top:300px;" title="客户活跃度" iconCls="icon-list"
...
<script type="text/javascript">
    ...
    function initSupplier() {
        ...
        //初始化排序下拉框
        $('#Sort').combobox({
            url: path +'/pages/reports/sortType.json',
            valueField:'value',
            textField:'name'
        });
    }
    ...
    function initTableData() {
        $('#tableData').datagrid({
            ...
            pageList: [10, 50, 100],
            columns: [[
                {title: '下单数量', field: 'number', width: 100},
    ...
    function showDetails(pageNo, pageSize) {
        $.ajax({
            type: "post",
            url: "<%=path %>/depotHead/sumCustomerActivity.action",
            dataType: "json",
            data: ({
                pageNo: pageNo,
                pageSize: pageSize,
